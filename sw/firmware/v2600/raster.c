...
unsigned int norm_val, scores_val;
unsigned int *colour_ptrs[2][3];

/* Normal priority */
static unsigned int colour_normal[64];
static unsigned int colour_normscoresl[64];
static unsigned int colour_normscoresr[64];

/* Alternate priority */
static unsigned int colour_alternate[64];
static unsigned int colour_altscoresl[64];
static unsigned int colour_altscoresr[64];

/* Playfield screen position */
static UINT32 *pf_pos;
static BYTE *line_ptr;
